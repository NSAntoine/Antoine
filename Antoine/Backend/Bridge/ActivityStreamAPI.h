...
//#include <xpc/xpc.h>
// all we really need from <xpc/xpc.h> is xpc_object_t
// and I don't feel like manually copy-pasting the entirety of xpc headers for one type
// (can't include <xpc/xpc.h> by default on iPhone)
...
typedef bool (^os_activity_stream_block_t)(os_activity_stream_entry_t _Nonnull entry,
                                           int error);
